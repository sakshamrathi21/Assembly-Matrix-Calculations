...
; ; Start of your code
        ...
        imul rcx, 8     ; rcx = 8n^2
        mov rdi, 0      ; rdi = 0
        mov rax, 12     ; sys_brk for allocating memory
        syscall         ; syscall
        mov [a1], rax   ; [a1] = matrix pointer which was returned by syscall 12
        mov rdi, rcx    ; rdi = 8n^2
        add rdi, rax    ; rdi = matrix end element(by adding the offset)
        mov rax, 12     ; sys_brk for allocating memory
        syscall         ; syscall
